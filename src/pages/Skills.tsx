...
const DEFAULT_SKILLS: Skill[] = [
    { id: '1', name: 'React', level: 60 },
    { id: '2', name: 'React Native', level: 70 },
    { id: '3', name: 'Node.js', level: 50 },
    { id: '4', name: 'Unity', level: 60 },
    { id: '5', name: 'MongoDB', level: 60 },
    { id: '6', name: 'MySQL', level: 80 },
]
...
export default function Skills({ skills = DEFAULT_SKILLS }: Props) {
    return (
        <section>
            ...
            <section className=" pb-8 pt-3 text-slate-50 tracking-tighter w-standard-md mx-auto flex justify-center items-center flex-col gap-10">
